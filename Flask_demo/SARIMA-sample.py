...
def Sarima(station):
    data = pd.read_csv("../result/" + station + ".csv", parse_dates=['date'], index_col='date')
    ...
    model = sm.tsa.statespace.SARIMAX(data, order=(param), seasonal_order=(param_seasonal), enforce_stationarity=False,
    ...
    data1.to_csv("../Forecast/csv/" + station + ".csv")
